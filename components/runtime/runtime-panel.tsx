...
import { describeError } from "@/components/runtime/queries";
import type { TelemtResult } from "@/lib/telemt/client";

/** Shared loading/error chrome for a runtime diagnostics tab; renders `children(data)` on success. */
export function RuntimePanel<T>({
  query,
  children,
}: {
